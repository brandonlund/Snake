...
{
   colorMap[CLEAR_VALUE] = olc::DARK_GREY;
   colorMap[TAIL_VALUE] = olc::BLACK;
   colorMap[HEAD_VALUE] = olc::GREY;
   colorMap[FOOD_VALUE] = olc::DARK_RED;
   colorMap[OBSTACLE_VALUE] = olc::DARK_BLUE;
   colorMap[COLLISION_VALUE] = olc::DARK_YELLOW;
   colorMap[PATH_VALUE] = olc::GREEN;
